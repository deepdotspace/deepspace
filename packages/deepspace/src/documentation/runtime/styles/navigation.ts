...
.documentation-brand-product { padding-left: 10px; border-left: 1px solid var(--documentation-border-strong); color: var(--documentation-muted); font-size: 12px; font-weight: 600; letter-spacing: .04em; }
...
.documentation-search-trigger kbd { padding: 2px 5px; border: 1px solid var(--documentation-border); border-radius: 5px; background: var(--documentation-panel); color: var(--documentation-faint); font: 600 10px/1.3 var(--documentation-font-mono); }

.documentation-top-links { display: flex; align-items: center; gap: 18px; height: 100%; padding: 0 24px 0 10px; }
.documentation-top-links a { display: inline-flex; align-items: center; gap: 4px; color: var(--documentation-muted); font-size: 13px; font-weight: 560; text-decoration: none; white-space: nowrap; }
...
.documentation-nav-section > h2 { margin: 0 0 7px; padding: 0 9px; color: var(--documentation-text-soft); font-size: 11.5px; font-weight: 720; letter-spacing: .025em; }
.documentation-nav-link { display: flex; align-items: center; justify-content: space-between; gap: 8px; min-height: 33px; margin: 1px 0; padding: 6px 9px; border-radius: 8px; color: var(--documentation-muted); font-size: 13.25px; line-height: 1.38; text-decoration: none; transition: background .12s, color .12s; }
...
.documentation-nav-folder > summary { display: flex; align-items: center; justify-content: space-between; min-height: 34px; padding: 6px 9px; border-radius: 8px; color: var(--documentation-muted); cursor: pointer; font-size: 13.25px; font-weight: 620; list-style: none; }
...
.documentation-sidebar-footer a, .documentation-sidebar-footer > span { color: var(--documentation-faint); font-size: 10.5px; text-decoration: none; }
