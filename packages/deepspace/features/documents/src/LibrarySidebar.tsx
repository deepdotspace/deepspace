    ...
    <div className="group flex w-full min-w-0 items-center gap-0.5">
      <button
        ...
        className={`flex h-9 min-w-0 flex-1 items-center gap-0 rounded-md pl-0.5 pr-0 text-left text-[13px] ${
          active
            ? 'bg-[color:var(--documents-el-accent)] font-medium text-white shadow-sm'
            : 'text-[color:var(--documents-el-text)]/80 transition-colors hover:bg-black/[0.04] hover:text-[color:var(--documents-el-text)] dark:hover:bg-white/[0.06]'
        }`}
      >
    ...
    >
      <div className="flex h-full min-h-0 flex-col">
        ...
        >
          ...
          >
            ...
            <div className="min-w-0">
              <span className="block truncate text-base font-bold leading-tight tracking-tight text-[color:var(--documents-el-text)]">
                Documents
              </span>
              <span className="block truncate text-[10px] font-semibold uppercase tracking-widest text-[color:var(--documents-el-muted)]/75">
                Workspace
              </span>
            </div>
          </div>
          <button
            ...
            className="absolute right-2.5 top-1/2 z-10 flex h-8 w-9 -translate-y-1/2 items-center justify-center rounded-md transition-colors hover:bg-black/[0.04] hover:text-[color:var(--documents-el-text)] dark:hover:bg-white/[0.06]"
        ...
        <nav className="flex-1 space-y-0.5 overflow-y-auto py-4 pl-3.5 pr-1.5">
          ...
          <div className="mt-8 border-t pt-3" style={{ borderColor: 'var(--documents-el-line)' }}>
            <span
              className={`mb-2 block pl-2.5 pr-0 text-[10px] font-bold uppercase tracking-widest text-[color:var(--documents-el-muted)]/80 ${
                collapsed ? 'pointer-events-none select-none opacity-0' : ''
              }`}
              aria-hidden={collapsed}
            >
            ...
            <div className="space-y-0.5">
              {sortedFolders.map((f) =>
                renamingFolderId === f.recordId ? (
                  ...
                  >
                    <span
                      className="flex h-9 w-10 shrink-0 items-center justify-center text-[color:var(--documents-el-muted)]"
                      aria-hidden
                    >
