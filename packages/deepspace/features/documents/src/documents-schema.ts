/**
 * Documents feature — record schemas
 *
 * `documents`: collaborative documents with optional folder placement.
...
/** Pass into `schemas` with spread: `[...documentsCollections, ...]` */
export const documentsCollections: CollectionSchema[] = [documentsSchema, docFoldersSchema]
